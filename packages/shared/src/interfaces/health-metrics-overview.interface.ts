 ...
 * list from and type-checks its readers against. The KPI side funnels through one `projectKpiRow`
 * projection; revenue is read by two inline `revenueAlias` calls, so a new field needs a reader by hand.
 */
