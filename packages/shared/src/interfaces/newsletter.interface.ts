 ...
 * `body_html` and manager-only fields (ed_reply_email, group_id, created_by)
 * are deliberately absent — the rendered body is fetched on demand via the
 * project-scoped single-newsletter endpoint.
 */
