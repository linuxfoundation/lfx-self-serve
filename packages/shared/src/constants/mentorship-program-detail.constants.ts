        ...
        tasks: [
          {
            id: 'tsk_apicurio_1',
            name: 'Resume',
            description: 'Upload a current resume.',
            status: 'submitted',
            prerequisite: false,
            createdOn: '2026-08-12',
          ...
          },
          {
            id: 'tsk_apicurio_2',
            name: 'Cover Letter',
            description: 'Explain your interest in the project.',
            status: 'pending',
            prerequisite: true,
            createdOn: '2026-08-12',
          ...
          },
          {
            id: 'tsk_apicurio_3',
            name: 'Code Sample',
            description: 'Share a recent code contribution.',
            status: 'pending',
            prerequisite: false,
            createdOn: '2026-08-12',
            updatedOn: '2026-08-12',
          },
          {
            id: 'tsk_apicurio_4',
            name: 'References',
            description: 'Provide two professional references.',
            status: 'pending',
            prerequisite: true,
            createdOn: '2026-08-12',
            updatedOn: '2026-08-12',
    ...
    mentees: [
      {
        ...
        tasks: [
          ...
          },
          {
            ...
            description: 'Submit your first weekly report.',
            status: 'submitted',
            prerequisite: false,
            createdOn: '2026-08-01',
          ...
          },
          {
            ...
            description: 'Submit your second weekly report.',
            status: 'submitted',
            prerequisite: false,
          ...
          },
          {
            ...
            description: 'Submit your third weekly report.',
            status: 'submitted',
            prerequisite: false,
            createdOn: '2026-08-15',
          ...
          },
          {
            id: 'tsk_janus_m7',
            name: 'Midterm Report',
            description: 'Summarize progress at the midpoint.',
            status: 'submitted',
            prerequisite: false,
            createdOn: '2026-08-01',
            updatedOn: '2026-08-25',
          ...
          },
          {
            id: 'tsk_janus_m8',
            name: 'Code Review',
            description: 'Submit code for mentor review.',
            status: 'submitted',
            prerequisite: true,
            createdOn: '2026-08-15',
            updatedOn: '2026-09-01',
          ...
          },
          {
            id: 'tsk_janus_m9',
            name: 'Final Report',
            description: 'Submit the final mentorship report.',
            status: 'submitted',
            prerequisite: true,
            createdOn: '2026-09-01',
            updatedOn: '2026-09-10',
