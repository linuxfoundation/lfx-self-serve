...
const PRODUCT_LINE =
  'Organization Lens shows how a company is involved in open source — the projects it contributes to, the people doing the work, and its membership footprint.';
...
export const ORG_LENS_EMPTY_STATE_COPY: Record<OrgLensEmptyStateName, OrgLensEmptyStateCopy> = {
  'no-organization': {
    ...
    reason:
      'Your account is not linked to an organization yet, so there is nothing to show here. Add your organization as an affiliation in your LFX profile. Once it is verified, it will appear here.',
  ...
  'staff-check-failed': {
    ...
    productLine: PRODUCT_LINE,
    reason: 'The staff access check did not complete. This is a system problem on our side, not a change to your permissions. Reference: {correlationId}',
