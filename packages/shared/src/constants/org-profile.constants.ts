...
/** MIME types accepted for org logo uploads (LFXV2-2016/LFXV2-3288). SVG excluded, matching member-service's allow-list (`pkg/constants/logo.go`) pending a sanitizer decision. */
export const ALLOWED_ORG_LOGO_MIME_TYPES = ['image/png', 'image/jpeg'] as const;
