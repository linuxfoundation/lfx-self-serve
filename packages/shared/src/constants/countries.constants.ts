...
/**
 * Complete ISO 3166-1 alpha-2 country list for use in dropdowns and forms.
 *
 * Holds all 249 officially assigned alpha-2 codes. User-assigned ranges (AA, QM-QZ,
 * XA-XZ, ZZ) and exceptionally/transitionally reserved codes (EU, UK, SU, AN, ...) are
 * deliberately excluded, so membership in this list implies the code is officially
 * assigned -- which makes it safe to use as a validation allow-list, not just as a
 * dropdown source.
 *
 * Sorted by label using codepoint ordering, which places 'Aland Islands' last.
 */
