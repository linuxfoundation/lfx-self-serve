 ...
 * addresses resolve against; never re-derived here, never the canonical record's. A slug equal to
 * an Org Lens page name is emitted as the SFID so a static route can never be shadowed (DR-007 §5,
 * T017a).
 *
