 ...
 * each other. Each part is trimmed before joining — directory and search-index records
 * carry padded halves, and a raw join would render them as a double space.
 */
