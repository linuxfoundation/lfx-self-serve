...
- [x] No unnecessary implementation details in stakeholder-facing requirements (languages, frameworks, APIs)
...
- [x] No unnecessary implementation details leak into stakeholder-facing requirements
