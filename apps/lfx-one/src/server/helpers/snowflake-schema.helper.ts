...
/** Resolves the `ANALYTICS.PLATINUM_LFX_ONE`-style schema every dbt-backed Snowflake read in this app is qualified with, env-overridable via `LFX_ONE_PLATINUM_SCHEMA`. */
