...
export class OrgEasyclaSignHandoffComponent {
  ...
  protected onReviewAndSign(): void {
    ...
    // Nothing is carried across the navigation. The signatory returns to the CLA Group's own detail
    // address (#2352), which is known before the signature exists and is enough to resolve the
    // agreement once EasyCLA has written it — so there is nothing for this moment to remember.
