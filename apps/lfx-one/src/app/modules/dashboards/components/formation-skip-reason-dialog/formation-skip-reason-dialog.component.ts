...
@Component({
  selector: 'lfx-formation-skip-reason-dialog',
  imports: [ReactiveFormsModule, ButtonComponent, TextareaComponent],
  templateUrl: './formation-skip-reason-dialog.component.html',
})
export class FormationSkipReasonDialogComponent {
  private readonly dialogRef = inject(DynamicDialogRef);
  private readonly dialogConfig = inject(DynamicDialogConfig);

  public readonly itemTitle = this.dialogConfig.data.itemTitle as string;
