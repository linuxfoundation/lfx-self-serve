...
import { MenteeResumeSectionComponent } from './mentee-resume-section.component';

describe('MenteeResumeSectionComponent', () => {
  let fixture: ComponentFixture<MenteeResumeSectionComponent>;
  let form: FormGroup<{ resumeFileName: FormControl<string> }>;

  const element = (): HTMLElement => fixture.nativeElement as HTMLElement;
  const fileName = (): string => element().querySelector('[data-testid="mentorship-mentee-resume-name"]')?.textContent?.trim() ?? '';
  const error = (): string | null => element().querySelector('[data-testid="mentorship-mentee-resume-error"]')?.textContent?.trim() ?? null;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [MenteeResumeSectionComponent],
      providers: [provideNoopAnimations()],
    });

    fixture = TestBed.createComponent(MenteeResumeSectionComponent);
  ...
  it('prompts for a file until one is chosen', () => {
    ...
    expect(element().querySelector('[data-testid="mentorship-mentee-resume-clear"]')).toBeNull();
  });
  ...
  it('clears a chosen resume, naming it for a screen reader', () => {
    ...
    const clear = element().querySelector('[data-testid="mentorship-mentee-resume-clear"]');
