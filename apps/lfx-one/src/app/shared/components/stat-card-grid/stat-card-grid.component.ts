...
import { StatCardDeltaDirection, StatCardItem } from '@lfx-one/shared/interfaces';
...
const DELTA_ICON: Record<StatCardDeltaDirection, string> = {
  up: 'fa-light fa-arrow-up',
  down: 'fa-light fa-arrow-down',
  flat: 'fa-light fa-minus',
};

const DELTA_TEXT_CLASS: Record<StatCardDeltaDirection, string> = {
  up: 'text-emerald-600',
  down: 'text-red-600',
  flat: 'text-gray-400',
};
