 ...
 * case-insensitively; `orgPathParamGuard` canonicalizes the address to lowercase afterwards) that is
 * not an Org Lens page name, or an 18-char SFID (spec 050, contracts/web-org-url-scheme.md §1).
 *
