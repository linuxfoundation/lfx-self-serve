...
/**
 * `/org/:orgSegment` matches only values shaped like an organization segment — a lowercase slug
 * that is not an Org Lens page name, or an 18-char SFID (spec 050, contracts/web-org-url-scheme.md §1).
 *
