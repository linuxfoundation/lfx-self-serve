...
import { Committee, Meeting, Vote } from '@lfx-one/shared/interfaces';
...
// The vote edit route (GH-1568) shares the same resolution through fetchVote — pinned identically.
