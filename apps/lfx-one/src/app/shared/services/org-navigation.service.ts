...
export class OrgNavigationService {
   ...
   * where it was (FR-022–FR-024 silent-substitution rule). A bootstrap already in flight keeps its own
   * pending intent — the flag is left untouched, never forced either way.
   */
