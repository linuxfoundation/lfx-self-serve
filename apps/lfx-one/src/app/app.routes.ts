...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      // with the LF root selected, which is what NavigationService.applyDefaultSelection seeds by
      // default (GH-2378) — it shows every formation, matching the original behavior.
