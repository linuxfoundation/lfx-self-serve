...
| `formation-mapper.helper.ts`  | Maps upstream `lfx-v2-formation-service` shapes (checklist, items) onto the BFF's `@lfx-one/shared` formation types — `sub_stage` normalization (GH-2366, GH-2328) instead lives in `packages/shared/src/utils/formation.utils.ts`'s `normalizeFormationSubStage`, called from both `formation.service.ts` (queue rows and, since GH-1956, the Me-lens formation-aggregate rows) and this file's `mapUpstreamFormationChecklist` (checklist reads, sourced from the project record's `stage` since the upstream checklist payload carries no stage field of its own); `getFormationQueueStageDisplay` is a separate render-side helper used by both `formations-table.component.ts` and `decorateMyFormation` in `packages/shared/src/utils/formation-me.utils.ts`, the My Formations page's row builder (GH-1956, #2753). This file also owns `deriveItemAction`/`resolveActionHref` (item-key/status-source-derived action affordance and template-link resolution) for the checklist read; the Me-lens `formation_item` rows carry neither since #2732, because the pending-action row's one control navigates to the checklist. |
...
| `settle-in-batches.helper.ts` | `settleInBatches` — sequential `Promise.allSettled` batches for bounded, best-effort per-item fan-out (e.g. one user-metadata lookup per listed person on the formation people card, #2724); never throws, one positional settled result per item                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `url-validation.ts`           | URL and cookie domain validation with allowlists                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `validation.helper.ts`        | TypeScript type guard validators for request parameters, plus query-param parsers: `getStringQueryParam`, and `clampInteger` / `parseOffsetPagination` for the interpolated `LIMIT`/`OFFSET` of Snowflake reads                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
