...
| ---------------------------- | --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `dashboardAccessGuard`       | `/foundation/health-metrics`                                                            | `canViewExecutiveDashboards()` — ED (sync cookie fast path) or LF Staff (async OpenFGA check via `refreshEnrichedPersonas()`)                                                                                                                 |
