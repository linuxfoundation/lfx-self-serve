...
| `orgSegmentMatchGuard`       | `/org/:orgSegment` (CanMatch)                                                                                            | Matches only values shaped like an organization segment — a lowercase slug that is not an Org Lens page name, or an 18-char SFID; anything else falls through to the in-shell 404 instead of a resolver round trip.                                                                                                                                                                                                                                                                                                                                                    |
