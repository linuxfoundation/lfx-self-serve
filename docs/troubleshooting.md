...
- **Ticket Tracking**: GitHub Issues on [`linuxfoundation/lfx-self-serve`](https://github.com/linuxfoundation/lfx-self-serve/issues) — file all bugs and issues there (see `.claude/rules/commit-workflow.md` § Ticket Tracking)
- **Architecture Questions**: Refer to architecture documentation
- **Environment Issues**: Check environment configuration guide

---

_This troubleshooting guide is specific to LFX One. For questions or additional issues, file a GitHub Issue on [`linuxfoundation/lfx-self-serve`](https://github.com/linuxfoundation/lfx-self-serve/issues)._
