...
| Variable                | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Example              |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------- |
| `VALKEY_URL`            | Shared Valkey connection URL (`rediss://` enables TLS). Unset disables caching (direct-fetch fallback) for most features — but weekly-brief AI action-item extraction (LFXV2-3043) skips extraction entirely rather than direct-fetching, since the cache is the only bound on AI proxy spend for that endpoint; unset `VALKEY_URL` means that feature always returns zero items.                                                                                                                                                                                                                                                    | `rediss://host:6379` |
