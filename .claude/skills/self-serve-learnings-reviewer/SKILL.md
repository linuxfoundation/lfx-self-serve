...
| `docs/reviews/knowledge-base/server-request-handling.md`     | interceptor order vs SSR cookies, guard ordering, new route classified public/optional, shared instance state, query-string casting/trimming/validation, id-format regexes |
